...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void updateMartialArt (int martialArtID, String martialArtName, double martialArtPrice, String martialArtColor) {
        SQLiteDatabase database = getWritableDatabase();
        String updateMartialArtSQLCommand = "update " + MARTIAL_ARTS_TABLE + " set " +
                NAME_KEY + " = '" + martialArtName + "', " + PRICE_KEY + " = '" + martialArtPrice + "', "
    ...
    public ArrayList<MartialArt> returnAllMartialArtObjects() {
        ...
        while(cursor.moveToNext()) {
            MartialArt currentMartialArtObject = new MartialArt(cursor.getInt(0),
    ...
    public MartialArt returnMartialArtByID (int id) {
        ...
        MartialArt martialArtObject = null; // local var must be initialized
        if (cursor.moveToFirst()) {
            martialArtObject = new MartialArt(cursor.getInt(0), cursor.getString(1),
